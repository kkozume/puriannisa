    ...
    <section class="section">
        <div class="container-fluid">
            ...
            <div class="card-header py-3">
                <a href="<?= site_url('pelanggan') ?>" class="btn btn-sm btn-primary" id="tmbh"><i class="fas fa-plus"></i> Tambah Data Pelanggan</a>
            </div>
            </div>
                <!-- Default box -->
            <div class="card shadow mb-4">
                    ...
                    foreach($pelanggan as $row):
                        ?>
                            <tr>
                                ...
                                <td>
                                  <a class="btn btn-info" href="<?= base_url('pelanggan/editpelanggan/'.$row['id_pelanggan']) ?>" role="button">
