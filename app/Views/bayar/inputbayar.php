      ...
      <div class="col-xs-4">
        ...
        <div class="card card-info">
          <div class="card-header">
            <h6 class="card-title font-weight-bold">Tambah Transaksi Pembayaran</h6>
                        ...
                        <div class="card-body">
                            <form action="<?= base_url('beli/tambah_pembelian')?>" method="POST">
                                ...
                                <div class="form-group row">
                                    <label for="id_pembelian" class="col-sm-2 col-form-label">ID Pembelian</label> <br>
                                    <div class="col-sm-10">
                                        <select class="form-select" name="id_pembelian" id="id_pembelian" required>
                                            <option value="">-</option>
                                ...
                                <div class="form-group row">
                                    <label for="id_byr" class="col-sm-2 col-form-label">ID Bayar</label> <br>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="id_byr" name="id_byr" value="<?= $kode ?>" readonly>
                                    </div>
                                </div>
                                <div class="form-group row">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <?php if ($detil->getNumRows() != 0) { ?>
                                <form action="<?= base_url('bayar/save_pembayaran')?>" method="POST">
