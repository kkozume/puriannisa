<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      ?>
        <div class="row">
        <?= form_open('pemodalan/tarikModal') ?>
                ...
                <div class="mb-3">
                    ...
                    <?php
                        if(isset($validation)){
                            //untuk mengecek apakah ada error pada elemen field kode_produk
                    ...
                    ?>
                    <input type="text" class="form-control" id="besar" name="besar" value="<?= set_value('besar')?>" placeholder="Diisi dengan besar modal yang ditarik">
                </div>
                ...
                <div class="mb-3">
                    ...
                    ?>
                    <input type="text" class="form-control" id="nama" name="nama" value="<?= set_value('nama')?>" placeholder="Diisi dengan nama / keterangan modal yang ditarik">
                </div>
