    ...
    <section class="section">
        <div class="container-fluid">
            ...
            <div class="card-header py-3">
                <a href="<?= site_url('kategori') ?>" class="btn btn-sm btn-primary" id="tmbh"><i class="fas fa-plus"></i> Tambah Data Kategori</a>
            </div>
            </div>
                <!-- Default box -->
            <div class="card shadow mb-4">
                    ...
                    foreach($kategori as $row):
                        ?>
                            <tr>
                                ...
                                <td>
                                  <a class="btn btn-info" href="<?= base_url('kategori/editkategori/'.$row['kode_kategori']) ?>" role="button">
